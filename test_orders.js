...
fetch(`https://hwgmjlsoeebgounmthmr.supabase.co/rest/v1/orders?select=id,order_items!inner(service_name,service:services(image_url,duration_minutes,cat:service_categories(image_url)))&order=id.desc&limit=1`, {
  headers: {
    apikey: key,
