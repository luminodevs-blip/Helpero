    ...
    const fetchOrder = async () => {
      try {
        ...
        setOrder({
          ...
          service_icon_url: raw.order_items?.[0]?.service?.service_categories?.image_url || raw.order_items?.[0]?.service?.image_url,
      ...
      .on("postgres_changes", {
        ...
        if (data) {
          ...
          setOrder(prev => ({
            ...
            service_icon_url: raw.order_items?.[0]?.service?.service_categories?.image_url || raw.order_items?.[0]?.service?.image_url || prev?.service_icon_url,
