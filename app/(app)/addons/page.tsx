        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-4">
          ...
          >
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 pt-4 pb-[180px]">
              ...
              <div className="h-[1px] bg-zinc-100 mb-[18px] -mx-5" />

              <p className="font-sans text-[14.5px] font-normal text-zinc-900 mb-4">
                Additional 30 mins added to your booking.
              </p>

              <div className="space-y-6">
                <div>
                  <h4 className="font-sans text-[15px] font-medium text-zinc-900 mb-0.5">What you get:</h4>
                ...
                <div>
                  <h4 className="font-sans text-[15px] font-medium text-zinc-900 mb-0.5">Not included:</h4>
                  <ul className="space-y-1">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-white pt-3 pb-[40px] px-5">
              ...
              <div className="absolute -top-[32px] left-0 right-0 h-[32px] bg-[#7B82F4] flex items-center justify-center gap-2 px-4 shadow-sm">
                <MdReceiptLong size={16} className="text-white shrink-0" />
