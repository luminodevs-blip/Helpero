...
import 'select_contact_model.dart';
export 'select_contact_model.dart';

class SelectContactWidget extends StatefulWidget {
  const SelectContactWidget({super.key});
...
class _SelectContactWidgetState extends State<SelectContactWidget> {
  late SelectContactModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectContactModel());
