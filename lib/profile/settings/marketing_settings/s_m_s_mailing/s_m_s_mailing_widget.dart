...
import 's_m_s_mailing_model.dart';
export 's_m_s_mailing_model.dart';

class SMSMailingWidget extends StatefulWidget {
  const SMSMailingWidget({super.key});

  static String routeName = 'SMS_mailing';
  static String routePath = '/push_not2C';

  @override
  State<SMSMailingWidget> createState() => _SMSMailingWidgetState();
}

class _SMSMailingWidgetState extends State<SMSMailingWidget> {
  late SMSMailingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SMSMailingModel());
