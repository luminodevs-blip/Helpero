...
import 'voucher_info_model.dart';
...
class _VoucherInfoWidgetState extends State<VoucherInfoWidget> {
  late VoucherInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VoucherInfoModel());
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 0.0, 3.0),
                  child: Text(
                    'Expires in',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.outfit(
