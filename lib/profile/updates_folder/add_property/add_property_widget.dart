...
import '/profile/updates_folder/add_property_complete/add_property_complete_widget.dart';
...
class _AddPropertyWidgetState extends State<AddPropertyWidget> {
  ...
  void initState() {
    ...
    _model.addressTextController ??=
        TextEditingController(text: FFAppState().stNewAddressDraft.fullAddress);
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(8.0, 44.0, 8.0, 16.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: (_model.nameLabelTextController.text == '')
                                ? null
                                : () async {
                                    _model.apiResponseAddress =
                                        await ManageHouseCall.call(
                                      authToken: currentJwtToken,
                                      fullAddress:
                                          _model.addressTextController.text,
                                      lat: FFAppState().stNewAddressDraft.lat,
                                      lng: FFAppState().stNewAddressDraft.lng,
                                      city: FFAppState().stNewAddressDraft.city,
                                      propertyType: _model.buildingType,
                                      unitNumber:
                                          _model.unitAptTextController.text,
                                      floor: _model.buildingType == 'Office'
                                          ? _model.floorTextController3.text
                                          : _model.floorTextController1.text,
                                      intercomCode:
                                          _model.numberTextController.text,
                                      gateCode:
                                          _model.gateCodeTextController.text,
                                      companyName:
                                          _model.floorTextController2.text,
                                      instructions: _model
                                    ...
                                    if ((_model.apiResponseAddress?.succeeded ??
                                        true)) {
                                      ...
                                      FFAppState().updateSelectedHouseStruct(
                                        (e) => e
                                          ..nameLabel = _model
                                              .nameLabelTextController.text
                                          ..propertyType = _model.buildingType
                                          ..fullAddress =
                                              _model.addressTextController.text,
                                      );
                                      FFAppState().deleteStNewAddressDraft();
                                      FFAppState().stNewAddressDraft =
                                          AddressStructStruct();
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Oops! Something went wrong while saving your address. Please try again.',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .secondaryBackground,
