                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          _model.claimVoucher =
                                              await ClaimVoucherCall.call(
                                            authToken: currentJwtToken,
                                            code: _model.textController.text,
                                          );

                                          if ((_model.claimVoucher?.succeeded ??
                                              true)) {
                                            safeSetState(() {
                                            ...
                                            if ((_model.getUserVouchersClaim
                                                    ?.succeeded ??
                                                true)) {
                                              _model.vouchersList = functions
                                                  .parseUserVouchers(
                                ...
                                Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final voucher = _model.vouchersList
                                          .where((e) =>
                                              e.targetAudience == _model.tab)
                                          .toList();
