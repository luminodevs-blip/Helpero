                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.goNamed(
                                      HowDoIRateMyProfessionalWidget.routeName,
                                      extra: <String, dynamic>{
                                        '__transition_info__': TransitionInfo(
                                          hasTransition: true,
                                          transitionType:
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    updateCallback: () => safeSetState(() {}),
                                    child: Support0Widget(
                                      title: 'How do I rate my professional?',
                                      offDivider: false,
                                    ),
                                  ),
                                ),
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.goNamed(
                                      WhereCanISeeMyPastOrdersWidget.routeName,
                                      extra: <String, dynamic>{
                                        '__transition_info__': TransitionInfo(
                                          hasTransition: true,
                                          transitionType:
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    updateCallback: () => safeSetState(() {}),
                                    child: Support0Widget(
                                      title: 'Where can I see my past orders?',
                                      offDivider: false,
                                    ),
                                  ),
                                ),
