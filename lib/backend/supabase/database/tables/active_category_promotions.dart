...
class ActiveCategoryPromotionsTable
    extends SupabaseTable<ActiveCategoryPromotionsRow> {
  @override
  String get tableName => 'active_category_promotions';

  @override
  ActiveCategoryPromotionsRow createRow(Map<String, dynamic> data) =>
      ActiveCategoryPromotionsRow(data);
}

class ActiveCategoryPromotionsRow extends SupabaseDataRow {
  ActiveCategoryPromotionsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ActiveCategoryPromotionsTable();
