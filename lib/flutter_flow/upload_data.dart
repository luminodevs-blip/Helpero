          ...
          children: [
            if (!kIsWeb) ...[
              Padding(
                ...
                child: ListTile(
                  title: Text(
                    'Where would you like to get the file?',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.getFont(
                      pickerFontFamily,
            ...
            if (!kIsWeb) ...[
              const Divider(),
              createUploadMediaListTile('Take a Photo', MediaSource.camera),
              const Divider(),
            ],
...
bool validateFileFormat(String filePath, BuildContext context) {
  ...
  ScaffoldMessenger.of(context)
    ...
    ..showSnackBar(SnackBar(
      content:
          Text('Wait, we don\'t support that file type. Try a different one!'),
    ));
  return false;
}
