...
import 'general_entry_first_model.dart';
export 'general_entry_first_model.dart';

class GeneralEntryFirstWidget extends StatefulWidget {
  const GeneralEntryFirstWidget({super.key});

  static String routeName = 'GeneralEntryFirst';
  static String routePath = '/generalef';

  @override
  State<GeneralEntryFirstWidget> createState() =>
      _GeneralEntryFirstWidgetState();
}

class _GeneralEntryFirstWidgetState extends State<GeneralEntryFirstWidget>
    with TickerProviderStateMixin {
  late GeneralEntryFirstModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GeneralEntryFirstModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        Future(() async {
          ...
          FFAppState().updateCurrentCountryStruct(
            (e) => e
              ...
              ..taxIsInclusive =
                  _model.loadedCountry?.firstOrNull?.taxIsInclusive
              ...
              ..minOrderAmount =
                  _model.loadedCountry?.firstOrNull?.minOrderAmount
              ..currencySymbol =
                  _model.loadedCountry?.firstOrNull?.currencySymbol,
          );
          safeSetState(() {});
        ...
        Future(() async {
          if (FFAppState().selectedAddress.fullAddress == '') {
            context.pushNamed(
    ...
    animationsMap.addAll({
      ...
      'navbarOnPageLoadAnimation': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
              ...
              children: [
                                          ...
                                          itemBuilder:
                                            ...
                                            return wrapWithModel(
                                              ...
                                              child: CategoryCardWidget(
                                                key: Key(
                                                  'Keyvgv_${gridViewServiceCategoriesRow.id!.toString()}',
                                                ),
                                        ...
                                        child: CarouselSlider.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            return AddBanersCaruselWidget(
                                              key: Key(
                                                  'Key6z3_${carouselIndex}_of_${carouselAppBannersRowList.length}'),
                                              title:
                                          ...
                                          child: CarouselSlider.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return InformationBlockWidget(
                                                key: Key(
                                                    'Key7vr_${carouselIndex}_of_${carouselAppBannersRowList.length}'),
                                                imageUrl:
                ...
                wrapWithModel(
                  ...
                  child: NavbarWidget(
                    ...
                    animationsMap['navbarOnPageLoadAnimation']!),
              ],
            ),
          ),
        ),
