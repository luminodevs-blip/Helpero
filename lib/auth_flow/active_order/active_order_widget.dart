...
export 'active_order_model.dart';

class ActiveOrderWidget extends StatefulWidget {
  const ActiveOrderWidget({super.key});

  static String routeName = 'ActiveOrder';
  static String routePath = '/activeOrder';
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 12.0, 0.0, 0.0),
                          child: Text(
                            'Master Alex has another order to pick up on the way and will be with you soon',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.outfit(
