...
import 'address_autocomplete_model.dart';
export 'address_autocomplete_model.dart';
...
class _AddressAutocompleteWidgetState extends State<AddressAutocompleteWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddressAutocompleteModel());
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, placeItemIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          _model.selectedAddress = getJsonField(
                                            placeItemItem,
                                            r'''$.place_name''',
                                          ).toString();
                                          safeSetState(() {});
