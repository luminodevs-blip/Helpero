...
import '/profile/updates_folder/subscription_bottom/subscription_bottom_widget.dart';
import '/index.dart';
                                            ...
                                            Align(
                                              ...
                                              child: Builder(
                                                builder: (context) =>
                                                  ...
                                                  onPressed: () async {
                                                    await Share.share(
                                                      'helpero://helpero.ca${GoRouterState.of(context).uri.toString()}',
                                                      sharePositionOrigin:
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                              ...
                                                              child:
                                                                ...
                                                                navigate:
                                                                  ...
                                                                  FFAppState()
                                                                      ...
                                                                      BookingDraftStruct
                                                                          .fromSerializableMap(
                                                                              jsonDecode('{\"selectedAddons\":\"[]\",\"visit\":\"{\\\"arrivalType\\\":\\\"standard\\\"}\"}'));
                                      ...
                                      FutureBuilder<List<ServicesRow>>(
                                        future: FFAppState().servicesMini(
                                          uniqueQueryKey:
                                              valueOrDefault<String>(
                                            widget.category?.id.toString(),
                                            '1',
