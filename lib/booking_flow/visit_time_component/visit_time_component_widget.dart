...
class VisitTimeComponentWidget extends StatefulWidget {
  ...
  State<VisitTimeComponentWidget> createState() =>
      _VisitTimeComponentWidgetState();
}

class _VisitTimeComponentWidgetState extends State<VisitTimeComponentWidget> {
  late VisitTimeComponentModel _model;
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              alignment: AlignmentDirectional(-1.0, 0.0),
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 60.0, 20.0),
                child: Text(
                  'Service duration — 5h 35m',
