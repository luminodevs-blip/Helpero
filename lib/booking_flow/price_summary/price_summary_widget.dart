                  ...
                  child: Column(
                    ...
                    children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  if (functions.formatAddonsShortSummary(
                                                              FFAppState()
                                                                  .activeBookingDraft
                                                                  .selectedAddons
                                                                  .toList()) !=
                                                              ...
                                                              TextSpan(
                                                                text:
                                                                    valueOrDefault<
                                                                        String>(
                                                                  formatNumber(
                                                                    (FFAppState().activeBookingDraft.totalPrice ??
                                                                            0.0) -
                                                                        (FFAppState().activeBookingDraft.itemsPrice ??
                                                                            0.0),
                                                                    formatType:
                                                                        FormatType
                                                                            .custom,
                      ...
                      Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final selectedAddons = functions
                                .filterAddonsByStage(
                                    FFAppState()
                                        .activeBookingDraft
                                        .selectedAddons
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, selectedAddonsIndex) {
                                final selectedAddonsItem =
                                    selectedAddons[selectedAddonsIndex];
                                return Container(
                                  decoration: BoxDecoration(),
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
