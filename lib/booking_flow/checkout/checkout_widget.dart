                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Container(
                                            ...
                                            child: Visibility(
                                              visible: _model.showDescription ==
                                                  true,
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                  ...
                                  Expanded(
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.paymentResult7?.succeeded ??
                                            true)) {
                                          _model.processStripePayment =
                                              await actions
                                          ...
                                          if (_model.processStripePayment!) {
                                            FFAppState()
